"use client";
// S1 — Placeholder role entry. This IS the entire access system in Phase 1 (AC9).
    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="max-w-3xl mx-auto p-8">
        ...
        <p className="text-slate-500 text-xs mt-8">
          Demo client links: <a className="underline" href="/c/demo-geyser">/c/demo-geyser</a> (geyser job) ·{" "}
          <a className="underline" href="/c/demo-acc">/c/demo-acc</a> (accidental damage job) ·{" "}
